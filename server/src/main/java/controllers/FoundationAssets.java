...
public class FoundationAssets implements Jooby.Module {
	...
	public void configure(Env env, Config conf, Binder binder) throws Throwable {
		env.router().get(Routes.FOUNDATION, () -> views.Placeholder.foundation.template(null));
		...
		env.router().get(Routes.FOUNDATION_V1 + "/**", () -> views.Placeholder.foundation.template(SocialEmbed.todo()));
