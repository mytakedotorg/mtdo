...
public class TakepublishedRecord extends UpdatableRecordImpl<TakepublishedRecord> implements Record15<Integer, Integer, String, String, JSONB, Timestamp, String, Timestamp, String, Integer, Integer, Integer, Integer, Integer, String> {

    private static final long serialVersionUID = 1136066689;
    ...
    @Override
    public Row15<Integer, Integer, String, String, JSONB, Timestamp, String, Timestamp, String, Integer, Integer, Integer, Integer, Integer, String> valuesRow() {
    ...
    @Override
    public TakepublishedRecord values(Integer value1, Integer value2, String value3, String value4, JSONB value5, Timestamp value6, String value7, Timestamp value8, String value9, Integer value10, Integer value11, Integer value12, Integer value13, Integer value14, String value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TakepublishedRecord(Integer id, Integer userId, String title, String titleSlug, JSONB blocks, Timestamp publishedAt, String publishedIp, Timestamp deletedAt, String deletedIp, Integer countView, Integer countLike, Integer countBookmark, Integer countSpam, Integer countIllegal, String imageUrl) {
        super(Takepublished.TAKEPUBLISHED);
