...
public class LoginlinkRecord extends UpdatableRecordImpl<LoginlinkRecord> implements Record6<String, LocalDateTime, LocalDateTime, String, Integer, String> {

    private static final long serialVersionUID = -1118662490;
    ...
    /**
     * Setter for <code>public.loginlink.redirect</code>.
     */
    public LoginlinkRecord setRedirect(String value) {
        set(5, value);
        return this;
    }

    /**
     * Getter for <code>public.loginlink.redirect</code>.
     */
    ...
    @Override
    public Row6<String, LocalDateTime, LocalDateTime, String, Integer, String> valuesRow() {
    ...
    public Field<String> field6() {
        return Loginlink.LOGINLINK.REDIRECT;
    }
    ...
    @Override
    public LoginlinkRecord value6(String value) {
        setRedirect(value);
        return this;
    }

    @Override
    public LoginlinkRecord values(String value1, LocalDateTime value2, LocalDateTime value3, String value4, Integer value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LoginlinkRecord(String code, LocalDateTime createdAt, LocalDateTime expiresAt, String requestorIp, Integer accountId, String redirect) {
        super(Loginlink.LOGINLINK);
