import database, { Database, Video, DocumentExcerpt, User, Article } from "./database";
...
export function getDocumentExcerptPrimaryDateKind(excerptId: string): string | null {
	for (let excerpt of database.excerpts) {
		if (slugify(excerpt.title) === excerptId) {
...
export function getArticle(username: string, titleSlug: string): Article | null {
	let user = getUser(username);
...
export function createArticle(username: string, title: string, blocks: TakeBlock[]): boolean {
	if (!title) {
...
export function updateArticleTitle(username: string, oldTitleSlug: string, newTitle: string): boolean {
...
export function updateArticle(username: string, titleSlug: string, newBlocks: TakeBlock[]): boolean {
